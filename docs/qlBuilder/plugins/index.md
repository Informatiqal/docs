...
In essence plugins are ESM JS files that expose a function, which is then loaded during `qlBuilder` startup. Have a look at the [developing plugin](developing.md) page for more info.
